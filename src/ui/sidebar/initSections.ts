 ...
 */
function createSliceBasisSection(): HTMLElement {
 ...
 */
function createSliceOffsetSection(): HTMLElement {
  const content = document.createElement('div');
 ...
 */
function createOrientationSection(): HTMLElement {
  const content = document.createElement('div');
 ...
 */
function createSimulationSection(): HTMLElement {
  const sliders = [
    createSlider({
      id: 'horizon',
      label: 'Horizon',
 ...
 */
function createExportImportSection(): HTMLElement {
  const content = document.createElement('div');
