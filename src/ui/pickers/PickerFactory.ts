 ...
 */
export interface PickerScrollbar {
 ...
 * @param id - Base ID (e.g., 'modePicker')
 * @param title - Display title (e.g., 'Render mode')
 * @returns Object containing overlay element and key child references
 */
export function createPicker(id: string, title: string): PickerResult {
  // Main overlay
