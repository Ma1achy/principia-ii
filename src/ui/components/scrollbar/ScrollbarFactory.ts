 ...
 * @param idPrefix - Base ID (e.g., 'custom-sb', 'stateBox-sb', 'picker-sb')
 * @param className - Optional class name for the scrollbar container
 * @returns The scrollbar container element
 */
export function createScrollbar(idPrefix: string, className: string | null = null): HTMLElement {
