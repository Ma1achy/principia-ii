...
export function updateLegendPanel(): void {
  ...
  function addSwatch(color: string, label: string): void {
  ...
  function addGradBar(css: string, labelLeft: string, labelRight: string): void {
