 ...
 * @param {UITreeStore} uiTree - UI tree store
 */
export function attachPrincipiaElements(uiTree) {
  ...
  uiTree.attachElement('sec-mode:header', secMode?.parentElement?.querySelector('.section-head')); // Section header
  ...
  uiTree.attachElement('sec-presets:header', secPresets?.parentElement?.querySelector('.section-head'));
  ...
  uiTree.attachElement('sec-z0:header', secZ0?.parentElement?.querySelector('.section-head'));
  ...
  uiTree.attachElement('sec-orient:header', secOrient?.parentElement?.querySelector('.section-head'));
  ...
  uiTree.attachElement('sec-sim:header', secSim?.parentElement?.querySelector('.section-head'));
  ...
  uiTree.attachElement('sec-state:header', secState?.parentElement?.querySelector('.section-head'));
 ...
 * @param {UITreeStore} uiTree - UI tree store
 * @param {string} sliderId - Slider node ID
 * @param {string} htmlId - HTML element ID (without 'slider-' prefix if present)
 */
function attachSlider(uiTree, sliderId, htmlId) {
  ...
  // Find slider parts
  const label = container.querySelector('.sl-label');
 ...
 * @param {UITreeStore} uiTree - UI tree store
 */
export async function syncCollapseState(uiTree) {
