 ...
 * @param {UITreeStore} uiTree - The UI tree store
 */
export function rebuildSidebarGrid(uiTree) {
 ...
 * @param {UITreeStore} uiTree - The UI tree store
 * @param {boolean} isCustomActive - Whether custom preset is active
 */
export function rebuildPresetsGrid(uiTree, isCustomActive) {
